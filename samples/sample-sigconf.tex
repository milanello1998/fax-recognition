...
\acmConference[MM'19]{Proceedings of MM'19}{October 21--25, 2019}{Nice, France}
\acmBooktitle{Proceedindgs of MM'19, October 21--25, 2019, Nice, France }
\acmPrice{15.00}
...
\author{Zhuo Li}
\email{Zhuo\_Li@StateStreet.com}
\affiliation{%
...
\begin{CCSXML}
	<ccs2012>
	<concept>
	<concept_id>10010405.10010497.10010504.10010507</concept_id>
	<concept_desc>Applied computing~Graphics recognition and interpretation</concept_desc>
	...
	<concept>
	<concept_id>10010405.10010497.10010504.10010509</concept_id>
	<concept_desc>Applied computing~Online handwriting recognition</concept_desc>
	<concept_significance>100</concept_significance>
	</concept>
	</ccs2012>
\end{CCSXML}

\ccsdesc[500]{Applied computing~Graphics recognition and interpretation}
\ccsdesc[300]{Applied computing~Optical character recognition}
\ccsdesc[100]{Applied computing~Online handwriting recognition}
...
\begin{description}
\item[(1)] Regulation and government standards allow and encourage faxing. Technically an e-signature might be enough for somebody, but the legality of an e-signature can't be intuitively recognized and accepted. Many people just don't want to take the risk.
\item[(2)] Many believe FAX is more secure than email. Technically a secure email can also save you from malware and ransomware but it is much expensive than a FAX machine.
\item[(3)] FAX can provide a complete trail including confirmations of document receipt. This provides extra strengthen for communication resiliency.
\end{description}
...
\begin{itemize}
	\item FAX image quality could vary widely for different reasons. Sometimes it is a "refaxed" version which reduced the quality, sometimes the FAX machine itself may run out of ink.
	\item Unstructured FAX content requires more efforts to extract useful information distributed in it.
	\item handwritings on FAX files require technologies like OCR and NLP to either verify its integrity or understand its semantics. Examples include handwritten signatures and comments on FAXes.
\end{itemize}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=8.5cm]{figure6}
...
\begin{table*}
	\caption{Averaged time overhead of the machine learning models}
	\label{time}
	\begin{tabular}{cccc}
		\toprule
		\multirow{2}{3cm}{\textbf{Component}} & \multirow{2}{1cm}{\textbf{Model}} & 
		\multicolumn{2}{c}{\textbf{Time}} \\
		\cline{3-4}
		& & Training & Inference \\
		\midrule
		\multirow{2}{3cm}{Signature Verification} & Faster R-CNN & 96 hours & 0.42 sec \\
		& A-softmax & 72 hours & 0.19 sec \\
		Template Classification & GoogleNet & 72 hours & 0.18 sec \\
		\multirow{2}{3cm}{Data Extraction} & Light-head R-CNN & 24 hours & 0.79 sec \\
		& CRNN & 96 hours & 2.79 sec \\
		\bottomrule
	\end{tabular}
\end{table*}
...
The authors would thank Cristoforo, Jerry A, Jianling Sun, Shanping Li, Bo Zhou, Xiaohu Yang, Hao Zhu, Wei Xu, Xiaoyu Mao, Xiaochun Zhu and others who contributed and supported us for development and deployment of the system.
